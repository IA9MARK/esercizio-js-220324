...
if (utenteCheEffettuaLAcquisto.isAmbassador){
    sommaCarrello = sommaCarrello - ((sommaCarrello*30)/100)
}
...
for(let i= 0 ; i<arrayUtenti.length; i++) {
  console.log('Nome: ${arrayUtenti[i].name}; cognome: ${arrayUtenti[i].lastName}, ambassador: ${arrayUtenti[i].isAmbassador ? "E ambassador" : "Non è ambassador"}')
}   //non riesco a visualizzare gli array name lastname e amassador


  const arrayAmbassador= []
  arrayAmbassador.push("Marco")
